...
const ROLE_CARDS = {
  admin: { icon: Shield, title: "Admin console", body: "Manage chefs, zones, gateways, and verifications.", to: "/dashboard" },
  chef: { icon: ChefHat, title: "Chef kitchen", body: "Manage your menu, accept orders, track payouts.", to: "/dashboard" },
  customer: { icon: ShoppingBag, title: "Order food", body: "Browse home chefs near you and track your orders.", to: "/dashboard" },
  delivery: { icon: Bike, title: "Delivery", body: "Accept jobs, navigate, and confirm drop-offs.", to: "/dashboard" },
} as const;
